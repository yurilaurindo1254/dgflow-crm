...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
        ...
        // 1. Revenue
        const { data: incomeTxets } = await supabase
            .from('transactions')
            .select('*')
            .eq('type', 'income')
            .eq('status', 'paid')
        ...
        // 2. Expenses (Mocking or fetching if we had 'expense' type logic fully populated)
        // Assuming we handle expenses similarly
         const { data: expenseTxets } = await supabase
            .from('transactions')
            .select('*')
            .eq('type', 'expense')
            .eq('status', 'paid')
      ...
      <div className="relative p-8 space-y-8 pb-24 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-zinc-400 font-medium">Bem-vindo de volta, aqui está o resumo do seu negócio.</p>
          </div>
        ...
        {loading ? (
          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[160px]">
                  ...
                  <SpotlightCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between p-8 group" spotlightColor="rgba(16, 185, 129, 0.15)" hoverBorderColor="rgba(16, 185, 129, 0.5)">
                      <div className="flex justify-between items-start">
                          <div className="space-y-4">
                              <div className="flex items-center gap-2">
                                  ...
                                  <h3 className="text-zinc-400 font-medium">Receita Mensal</h3>
                              </div>
                              <div className="space-y-1">
                          ...
                          <div className="p-4 bg-zinc-900/50 rounded-2xl border border-white/5 text-primary-500 shadow-2xl group-hover:scale-110 transition-transform">
                              <DollarSign size={32} />
                          </div>
                      </div>
                  ...
                  <SpotlightCard className="p-6 flex flex-col justify-between" spotlightColor="rgba(244, 63, 94, 0.15)" hoverBorderColor="rgba(244, 63, 94, 0.5)">
                      ...
                      <div>
                          <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1">Despesas</p>
                  ...
                  <SpotlightCard className="p-6 flex flex-col justify-between" spotlightColor="rgba(168, 85, 247, 0.15)" hoverBorderColor="rgba(168, 85, 247, 0.5)">
                      ...
                      <div>
                          <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1">Novos Leads</p>
                  ...
                  <SpotlightCard className="p-6 flex flex-col justify-between" spotlightColor="rgba(16, 185, 129, 0.15)" hoverBorderColor="rgba(16, 185, 129, 0.5)">
                      ...
                      <div>
                          <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1">Lucro Líquido</p>
                  ...
                  <SpotlightCard className="p-6 flex flex-col justify-between" spotlightColor="rgba(59, 130, 246, 0.15)" hoverBorderColor="rgba(59, 130, 246, 0.5)">
                      ...
                      <div>
                          <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1">Conversão</p>
                  ...
                  <SpotlightCard className="p-6 flex flex-col justify-between" spotlightColor="rgba(249, 115, 22, 0.15)" hoverBorderColor="rgba(249, 115, 22, 0.5)">
                      ...
                      <div>
                          <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1">Em Andamento</p>
                          <p className="text-2xl font-bold text-white">{metrics.activeProjects} Projetos</p>
                      </div>
                  </SpotlightCard>
              </div>

              {/* Charts Section */}
              <div className="bg-zinc-900/30 backdrop-blur-xl border border-white/10 rounded-2xl p-8 relative group hover:border-white/20 transition-all duration-500 shadow-2xl">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
                      <div>
                          <h3 className="text-xl font-bold text-white tracking-tight">Análise Financeira Consolidada</h3>
                          <p className="text-sm text-zinc-400 mt-1">Desempenho de faturamento e despesas nos últimos 6 meses</p>
                      </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                   ...
                   <div className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-2xl p-8 min-h-[350px] flex flex-col group hover:border-white/10 transition-all duration-500">
                      <div className="flex justify-between items-center mb-6">
                          <h3 className="text-lg font-bold text-white tracking-tight">Projetos Recentes</h3>
                      ...
                      <div className="flex-1 flex flex-col items-center justify-center text-zinc-500 py-12">
                          ...
                          <p className="text-white font-semibold">Nenhum projeto em andamento</p>
